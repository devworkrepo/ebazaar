...
String dmtReceiptHtmlPage(PrintReceipt data, int commissionAmount){
  return """
                                    ...
                                    <div class="col-md-12" id="dvContents">
                                        ...
                                        <table style="width: 100%;font-size: 15px;border: 1px solid black; border-collapse: collapse;" >
                                            ...
                                            <tr style="" id="trandetailbybps">
                                                <td>
                                                    <b class="cs" > Account No :</b><span >${data.accountNumber ?? ""}</span><br />
                                                ...
                                                <td>
                                                    ...
                                                    <b class="cs" > IFSC Code :</b><span >${data.ifscCode ?? ""}</span><br />
