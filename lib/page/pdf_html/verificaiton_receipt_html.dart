...
String verificationReceiptHtmlPage(PrintReceipt data) {
  return """
                                          ...
                                          <tr>
                                                <td colspan="3" style="padding: 0px;" >                                                   
                                                    <div class="cs col-md-12 col-sm-12 col-xs-12">
                                                        <b>Total Amount Rs. : </b>
                                                        <label id="printAmount">${(data.amount ?? 0)}</label>&nbsp;&nbsp;&nbsp;
                                                    </div>
                                                    <div class="cs col-md-12 col-sm-12 col-xs-12">
                                                        <b>Amount in Words :</b>
                                                        <label id="prt_tranword">${(NumberToWord().convert("en-in", (data.amount ?? 0))).toUpperCase()}  Rupees Only/-</label>
                                                    </div>
                                                </td>
                                            </tr>  
                                             <tr>
