...
String billReceiptHtmlPage(PrintReceipt data){
  return """
  <style>
    .modal-body {
        line-height: 21px;
                                        ...
                                        <style>
                                         ...
                                         <table style="width: 100%; border: 1px solid #888;" >
                                            <tr>
                                                ...
                                                <td style="text-align:center"> <b>Outlet Namze: ${data.shopName ?? ""}<br>Address: ${data.shopAddress ?? ""}<br>Contact Number: ${data.shopContactNumber ?? ""}</b></td>
                                                <td> <img src="https://spayindia.com/newlog/images/bbps_logo.jpg" style="width: 40px;"></td>
                                         </table>
                                        <table style="width: 100%; border: 1px solid #888;" >
                                            <tr>
                                            ...
                                            <tr style="border-top:1px solid #ddd;" id="trandetailbybps">
                                                <td>
                                                    <b class="cs" >Biller Name : </b>
													<span id="printBillerName"> ${data.billerName ?? ""} </span><br /> 
                                                    <b class="cs" >Customer Mobile No :</b><span id="printCustomerNumber">${data.customerMobNO ?? ""}</span><br />
                                                    <b class="cs" >Payment channel :</b><span id="prt_tranchannel">${data.paymentChannel ?? ""}</span><br />
                                                </td>
                                                <td>
                                                    <b class="cs" >Consumer ID/Number : </b><span id="printConsumerNumber">${data.consumerIdNo ?? ""}</span><br />
                                                    <b class="cs" >Payment Mode : </b>${data.paymentMode ?? ""}<br />
                                                    <b class="cs" >Date & Time : </b><span id="printDate">${data.createdAt ?? ""}</span>
                                          ...
                                          <tr>
                                              ...
                                              <tr>
                                                   <td colspan="3" style="padding: 0px 8px;" >                
                                                    ...
                                                    <p style="margin: 0 0 0px !important; font-size: 12px">Dear Consumer, your payment will reflect in next 72 hours or in the next billing cycle, at your service provider end</p>
