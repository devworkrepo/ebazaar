...
import 'package:ebazaar/page/aeps/aeps_e_kyc/aeps_e_kyc_page.dart';
import 'package:ebazaar/page/aeps/aeps_airtel/aeps_page.dart';
import 'package:ebazaar/page/aeps/aeps_tramo/aeps_page.dart';
import 'package:ebazaar/page/aeps_settlement/account_status/account_status_page.dart';
import 'package:ebazaar/page/aeps_settlement/add_bank/add_bank_page.dart';
import 'package:ebazaar/page/aeps_settlement/bank_transfer/aeps_bank_transfer_page.dart';
import 'package:ebazaar/page/aeps_settlement/select_bank/select_bank_page.dart';
import 'package:ebazaar/page/app_setting/login_session_page.dart';
import 'package:ebazaar/page/auth/login/login_page.dart';
import 'package:ebazaar/page/auth/login_otp/login_otp_page.dart';
import 'package:ebazaar/page/auth/signup/signup_page.dart';
import 'package:ebazaar/page/cms_service/cms_service_page.dart';
import 'package:ebazaar/page/complaint/complain_info/complain_info_page.dart';
import 'package:ebazaar/page/credit_card/credit_card_page.dart';
import 'package:ebazaar/page/device_security_page.dart';
import 'package:ebazaar/page/dmt/beneficiary_add/beneficiary_add_page.dart';
import 'package:ebazaar/page/dmt/beneficiary_list/beneficiary_page.dart';
import 'package:ebazaar/page/dmt/dmt_transaction/dmt_transaction_page.dart';
import 'package:ebazaar/page/dmt/import_beneficiary/import_beneficiary_tab.dart';
import 'package:ebazaar/page/dmt/kyc_info/sender_kyc_info_page.dart';
import 'package:ebazaar/page/dmt/search_sender/search_sender_page.dart';
import 'package:ebazaar/page/dmt/sender_add/sender_add_page.dart';
import 'package:ebazaar/page/dmt/sender_change/change_mobile/sender_change_mobile_page.dart';
import 'package:ebazaar/page/dmt/sender_change/change_name/sender_change_name_page.dart';
import 'package:ebazaar/page/dtm_ekyc/dmt_ekyc_page.dart';
import 'package:ebazaar/page/fund/fund_request_page.dart';
import 'package:ebazaar/page/investment/bank_list/investment_bank_list_page.dart';
import 'package:ebazaar/page/investment/create/create_investment_page.dart';
import 'package:ebazaar/page/investment/detail/investment_detail_page.dart';
import 'package:ebazaar/page/investment/list/investment_list_page.dart';
import 'package:ebazaar/page/investment/pan/investment_pan_page.dart';
import 'package:ebazaar/page/investment/statement/investment_statement_page.dart';
import 'package:ebazaar/page/investment/summary/investment_summary_page.dart';
import 'package:ebazaar/page/investment/transfer/investment_transfer_page.dart';
import 'package:ebazaar/page/investment/withdrawn/investment_withdrawn_page.dart';
import 'package:ebazaar/page/main/change_password/change_password_page.dart';
import 'package:ebazaar/page/main/change_pin/change_pin_page.dart';
import 'package:ebazaar/page/main_page.dart';
import 'package:ebazaar/page/matm_credo/matm_credo_page.dart';
import 'package:ebazaar/page/ott/ott_operator/ott_operator_page.dart';
import 'package:ebazaar/page/paytm_wallet/paytm_wallet_page.dart';
import 'package:ebazaar/page/recharge/bill_payment/bill_payment_page.dart';
import 'package:ebazaar/page/recharge/lic_online_payment/lic_online_page.dart';
import 'package:ebazaar/page/recharge/provider/provider_page.dart';
import 'package:ebazaar/page/recharge/recharge/recharge_page.dart';
import 'package:ebazaar/page/report/security_deposit_report/security_deposit_report_page.dart';
import 'package:ebazaar/page/report/transaction_tab.dart';
import 'package:ebazaar/page/report/wallet_pay/wallet_report_page.dart';
import 'package:ebazaar/page/security_deposit/security_deposit_page.dart';
import 'package:ebazaar/page/summary/summary_page.dart';
import 'package:ebazaar/page/upi_payment/upi_payment_page.dart';
import 'package:ebazaar/page/virtual_account/account/virtual_account_page.dart';
import 'package:ebazaar/page/virtual_account/report/transaction_tab.dart';
import 'package:ebazaar/page/wallet_to_wallet/wallet_search/wallet_search_page.dart';
import 'package:ebazaar/page/wallet_to_wallet/wallet_transfer/wallet_transfer_page.dart';
import 'package:ebazaar/route/route_name.dart';
import 'package:ebazaar/test/test_credo_pay.dart';
import 'package:ebazaar/test/test_local_auth_page.dart';
import 'package:ebazaar/test/test_notification_page.dart';
import 'package:ebazaar/test/test_pg.dart';
